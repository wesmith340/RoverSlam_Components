...
PATH_TO_SAVED_MODEL = "./ObjectDetection/MRO/MRO/export/saved_model"
...
category_index = label_map_util.create_category_index_from_labelmap('./ObjectDetection/MRO/MRO/label_map.pbtxt', use_display_name=True)
listener()
